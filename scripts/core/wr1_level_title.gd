...
func configure(level: int) -> void:
	...
	if preload("res://scripts/core/wr1_clear_text.gd").enabled():
		...
		preload("res://scripts/core/wr1_clear_text.gd").label(self, Rect2(42,59,236,12), title.heading, Color.BLACK, 9)
		preload("res://scripts/core/wr1_clear_text.gd").label(self, Rect2(42,71,236,12), title.name, Color.BLACK, 9)
	set_process(false)
